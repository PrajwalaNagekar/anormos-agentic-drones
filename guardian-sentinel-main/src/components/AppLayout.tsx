    ...
    <div className="min-h-screen flex w-full bg-background">
      ...
      <div className="flex-1 flex flex-col min-h-screen overflow-hidden">
        <header className="h-10 flex items-center border-b border-border px-2 shrink-0">
          ...
          <img src={anormosLogo} alt="ANORMOS skAI" className="h-6 w-auto ml-2 object-contain" />
          <span className="text-[10px] font-display text-primary ml-2 tracking-wider hidden sm:inline">ANORMOS <span className="text-foreground">sk</span><span className="text-accent">AI</span></span>
