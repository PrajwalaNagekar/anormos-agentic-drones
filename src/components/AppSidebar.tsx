import {
  ...
  BarChart3, Cpu, Download, FlaskConical, Link2, ShieldCheck, Settings, LogOut, Shield
} from 'lucide-react';
      ...
      <SidebarContent>
        ...
        <div className={`p-4 border-b border-sidebar-border ${collapsed ? 'px-2' : ''}`}>
          <div className="flex items-center gap-2">
            <Shield className="w-6 h-6 text-sidebar-primary shrink-0" />
            {!collapsed && (
              <div>
                <h2 className="text-sm font-display font-bold tracking-[0.2em] text-sidebar-primary">SYNDICATE</h2>
        ...
        {!collapsed && (
          <div className="mt-auto p-4 border-t border-sidebar-border">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-[10px] font-mono text-sidebar-foreground">OPR-2741 | MAJ. AL-THANI</span>
            </div>
